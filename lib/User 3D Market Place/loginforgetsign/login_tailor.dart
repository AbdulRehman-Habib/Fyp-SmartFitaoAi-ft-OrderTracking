...
class LoginTailorScreen extends StatefulWidget {
  @override
  _LoginTailorScreenState createState() => _LoginTailorScreenState();
}
...
class _LoginTailorScreenState extends State<LoginTailorScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      // Store tailor login data in Firestore
      await FirebaseFirestore.instance.collection('login_app_tailor_login').add({
